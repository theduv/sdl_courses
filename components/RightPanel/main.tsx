...
const RightPanel = () => {
  ...
  return (
    <div
      ref={refTop}
      className={clsx(
        "max-[700px]:w-full bg-gray-800 border border-gray-500 overflow-y-auto fixed right-0 h-4/5 w-2/5 transition ease-in-out rounded-l-lg flex flex-col scrollbar scrollbar-thumb-gray-600 scrollbar-thumb-rounded scrollbar-track-gray-100 scrollbar-track-rounded ",
        {
